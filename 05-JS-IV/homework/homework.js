...
function agregarPropiedad(objeto, property) {
  ...
  // Devuelve el objeto
  // NOTA: El nombre de la propiedad no es "propiedad", el 
  //       nombre es el valor del argumento llamado "property" (una cadena/string)
  // Tu código:
...
function sumarLikesDeUsuario(usuario) {
  ...
  for(var i=0;i<usuario.posts.length;i++){
    var sumatoria=sumatoria+usuario.posts[i].likes;
  }
  return sumatoria;
}
