...
function numeroMasGrande(numeros) {
  ...
  // Tu código:
  var máximo=numeros[0];
  for(var i=1;i<numeros.length;i++){
    if(máximo<=numeros[i]) máximo=numeros[i]
  }
  return máximo;
...
function mesesDelAño(array) {
  ...
  var arreglo=[];
  for(var i=0;i<array.length;i++){
    if(array[i]==="Enero") arreglo.push("Enero");
    else if(array[i]==="Marzo" ) arreglo.push("Marzo")
    else if(array[i]==="Noviembre" ) arreglo.push("Noviembre");
    }
